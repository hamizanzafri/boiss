...
@endsection
@section('content')
    <div class="authentication-bg min-vh-100" style="background-image: url('https://wallpapercave.com/wp/FznC6ff.jpg');">
                            ...
                            <div class="text-center p-4">
                                <p>©
                                    <script>
                                        ...
                                        class="mdi mdi-heart text-danger"></i> by GrapeExclusive
